...
# Carrega somente configurações que também funcionam sem PostgreSQL.
$allowed = @('ESCRITORIO_NOME', 'SECRET_KEY', 'DEBUG', 'ALLOWED_HOSTS',
    'CSRF_TRUSTED_ORIGINS', 'PRIMARY_DOMAIN', 'ADMIN_USERNAME',
    'ADMIN_PASSWORD', 'ADMIN_EMAIL', 'ANTHROPIC_API_KEY', 'OPENAI_API_KEY',
    'IA_EMBEDDING_BACKEND', 'IA_CLAUDE_MODEL', 'Q_SYNC')
